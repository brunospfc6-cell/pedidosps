...
const APP_NAME = "Pro-Systems · Compras e Vendas";
...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "theme-color", content: "#1f4e57" },
      {
        name: "description",
        content: "Controle de compras e vendas da Pro-Systems, revenda autorizada Autodesk.",
      },
    ],
    links: [
